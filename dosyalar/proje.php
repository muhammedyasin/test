                    ...
                    <tr>
                        ...
                        if($durumsorgu != null) foreach( $durumsorgu as $drm ) {
                            ...
                            <td class="project_progress">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="90" aria-valuemin="10" aria-valuemax="100" style="width: <?php echo $drm['arge']; ?>%">
                                        <span class="sr-only"><?php echo $drm['arge']; ?>% Complete (success)</span>
                                    </div>
                                </div>
                                <center><b>% <?php echo $drm['arge']; ?></b></center>
                            </td>
                            <td>
                                <?php
                                if($drm['arge']==100)
